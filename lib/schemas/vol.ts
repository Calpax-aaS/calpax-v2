...
export const volCreateSchema = z.object({
  ...
  equipierId: z.string().optional().or(z.literal('')),
  equipierAutre: z.string().optional().or(z.literal('')),
  vehiculeId: z.string().optional().or(z.literal('')),
  vehiculeAutre: z.string().optional().or(z.literal('')),
  siteDecollageId: z.string().optional().or(z.literal('')),
  lieuDecollageAutre: z.string().optional().or(z.literal('')),
