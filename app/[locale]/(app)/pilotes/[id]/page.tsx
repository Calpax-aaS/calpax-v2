    ...
    return (
      <main className="container mx-auto max-w-2xl px-4 py-8 space-y-6">
        ...
        <Card>
          ...
          <CardContent className="grid grid-cols-2 gap-x-8 gap-y-3 text-sm">
            <div>
              <p className="text-muted-foreground">{t('fields.classesBfcl')}</p>
            ...
            <div>
              <p className="text-muted-foreground">{t('fields.groupesA')}</p>
              <div className="flex gap-1 flex-wrap mt-1">
                {([1, 2, 3, 4] as const)
            ...
            <div>
              <p className="text-muted-foreground">{t('fields.qualificationNuit')}</p>
              <div className="mt-1">
            ...
            <div>
              <p className="text-muted-foreground">{t('fields.qualificationInstructeur')}</p>
              <div className="mt-1">
            ...
            <div>
              <p className="text-muted-foreground">{t('fields.qualificationCaptif')}</p>
              <div className="mt-1">
